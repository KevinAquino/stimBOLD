...
%  $Revision: 1.58 $
%  Modifications by Wenbin, wenbin@ymail.com
%  Ver. 8-Apr-2014 Font size changes to 1.2 times. 
...
TextInfo.FontSize           =ceil(BtnFontSize*1.3); % BtnFontSize
