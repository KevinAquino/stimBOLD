...
function visualization_handle = visualization_figure(visual_response,BOLD,zeta,msh,params)

visualization_handle = figure(10);

clf
set(visualization_handle,'Color','white');
nn = 1;
ind = 1;
meanZ = mean(zeta,2);
maxZ = max(meanZ);
